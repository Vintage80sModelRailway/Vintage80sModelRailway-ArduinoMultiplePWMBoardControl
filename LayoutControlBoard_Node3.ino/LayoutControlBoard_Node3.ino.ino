...
void InitialiseConfig() {
  ...
  PWMBoards[0].turnouts[0] = Turnout(950,1700,false); //thrown, closed, invertfrog
  PWMBoards[0].turnouts[1] = Turnout(1000,1700,false); //thrown, closed, invertfrog
  PWMBoards[0].turnouts[2] = Turnout(950,1700,true); //thrown, closed, invertfrog
  PWMBoards[0].turnouts[3] = Turnout(1100,1900,true); //thrown, closed, invertfrog
  PWMBoards[0].turnouts[4] = Turnout(1100,2000,false); //thrown, closed, invertfrog
  PWMBoards[0].turnouts[5] = Turnout(1200,2100,true); //thrown, closed, invertfrog
  PWMBoards[0].turnouts[6] = Turnout(1200,2000,false); //thrown, closed, invertfrog
  PWMBoards[0].turnouts[7] = Turnout(1100,1850,false); //thrown, closed, invertfrog


  //Board 2
  //PWMBoards[1].pwm = Adafruit_PWMServoDriver(0x41);
  //PWMBoards[1].numberOfServos = 0;
