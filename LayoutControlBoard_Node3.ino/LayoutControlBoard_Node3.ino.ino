...
void InitialiseConfig() {
  ...
  PWMBoards[0].turnouts[0] = Turnout(950,1700,3,false); //thrown, closed, invertfrog
  PWMBoards[0].turnouts[1] = Turnout(1000,1700,4,false); //thrown, closed, invertfrog
  PWMBoards[0].turnouts[2] = Turnout(950,1700,5,false); //thrown, closed, invertfrog
  PWMBoards[0].turnouts[3] = Turnout(1100,1900,6,true); //thrown, closed, invertfrog
  PWMBoards[0].turnouts[4] = Turnout(1100,2000,7,false); //thrown, closed, invertfrog
  PWMBoards[0].turnouts[5] = Turnout(1200,2100,8,false); //thrown, closed, invertfrog
  PWMBoards[0].turnouts[6] = Turnout(1200,2000,10,false); //thrown, closed, invertfrog
  PWMBoards[0].turnouts[7] = Turnout(1100,1850,9,false); //thrown, closed, invertfrog
