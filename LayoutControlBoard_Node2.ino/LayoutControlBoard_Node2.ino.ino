...
void InitialiseConfig() {
  ...
  PWMBoards[0].turnouts[1] = Turnout(1150,1650,4,false,true); //thrown, closed, invertfrog
  PWMBoards[0].turnouts[2] = Turnout(1200,2100,7,true,true); //thrown, closed, invertfrog
  PWMBoards[0].turnouts[3] = Turnout(1150,2000,10,true,true); //thrown, closed, invertfrog 
  PWMBoards[0].turnouts[4] = Turnout(1250,1700,8,false,true); //thrown, closed, invertfrog 
  PWMBoards[0].turnouts[5] = Turnout(1300,1810,9,true,true); //thrown, closed, invertfrog  
  PWMBoards[0].turnouts[6] = Turnout(1200,1850,6,false,true); //thrown, closed, invertfrog  
  PWMBoards[0].turnouts[7] = Turnout(1250,2000,5,true,true); //thrown, closed, invertfrog  
